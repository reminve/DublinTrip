...
export default function DashboardTab() {
  ...
  return (
    <div className="space-y-6">
        ...
        {tripState === 'ongoing' && (
          <div className="space-y-3">
            <div className="flex justify-between items-center text-sm font-semibold">
              ...
              <span class="text-slate-400">Voyage en cours 🇮🇪✈️</span>
            </div>
      ...
      {/* Budget Chart Card */}
      <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur">
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
          <h3 class="text-slate-300 text-sm font-bold flex items-center gap-2">
            <Plane className="w-4 h-4 text-emerald-400" /> Vols Aer Lingus
          </h3>
          <span className="text-[10px] bg-emerald-500/10 text-emerald-400 font-semibold px-2 py-0.5 rounded-full border border-emerald-500/20">T2 Dublin</span>
        </div>
        ...
        <div className="space-y-3.5">
          ...
          <div className="flex items-start justify-between text-sm">
            <div>
              <span className="text-xs bg-slate-800 text-slate-300 px-1.5 py-0.5 rounded font-mono">EI 553</span>
              <p className="font-semibold text-slate-200 mt-1">Lyon (LYS) T1 ➔ Dublin (DUB)</p>
              <p className="text-xs text-slate-500">J1 - 6 août | Décollage 16:45 - Arrivée 18:05</p>
            </div>
          ...
          <div className="flex items-start justify-between text-sm">
            <div>
              <span className="text-xs bg-slate-800 text-slate-300 px-1.5 py-0.5 rounded font-mono">EI 550</span>
              <p className="font-semibold text-slate-200 mt-1">Dublin (DUB) T2 ➔ Lyon (LYS)</p>
              <p class="text-xs text-slate-500">J7 - 12 août | Décollage 06:15 - Arrivée 09:30</p>
            </div>
          </div>
          
          <div className="bg-slate-950/60 border border-slate-800/60 rounded-xl p-3 text-xs text-slate-400 space-y-1">
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-3 text-xs text-amber-400 space-y-1.5">
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-5 shadow-lg backdrop-blur">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-slate-950/60 rounded-full flex items-center justify-center text-2xl">{weather.emoji}</div>
            <div>
